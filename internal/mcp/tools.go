...
func allTools() []mcp.Tool {
	return []mcp.Tool{
		...
		mcp.NewTool("pinchtab_screenshot",
			...
			mcp.WithString("tabId", mcp.Description("Target tab ID")),
			mcp.WithString("selector", mcp.Description("Unified selector to capture a specific element (ref, CSS, XPath, text, find, role, label, placeholder, alt, title, testid, first/last/nth). Selectors resolve in the current frame scope.")),
